 ...
 *    8base invoke-local neWResolver -p src/resolvers/neWResolver/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local neWResolver -m request
 *
 ...
 *    8base generate mock neWResolver -m [MOCK_FILE_NAME]
 */
